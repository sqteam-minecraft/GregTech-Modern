...
public class GTMachines {
    ...
    public static final MultiblockMachineDefinition SLOW_NEUTRON_FISSION_REACTOR = REGISTRATE
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .aisle("XWWWX", "W   W", "W   W", "W   W", "XRRRX")
                    .aisle("XWWWX", "W   W", "W   W", "W   W", "XRCRX")
                    .aisle("XWWWX", "W   W", "W   W", "W   W", "XRRRX")
                    .aisle("XXXXX", "XWWWX", "XWWWX", "XWWWX", "XXXXX")
                    ...
                    .where('R', blocks(CASING_REINFORCED_BOROSILICATE_GLASS.get())
                            .or(abilities(PartAbility.REACTOR_FUEL_CONTROL)))
                    .build())
            .allowExtendedFacing(false)
            .allowFlip(false)
            .workableCasingRenderer(GTCEu.id("block/casings/solid/machine_casing_solid_steel"),
