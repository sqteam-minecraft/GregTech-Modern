...
@OnlyIn(Dist.CLIENT)
public class DecayableTagPrefixItemModel extends Model
{
    private final ResourceLocation texture;
    private final ResourceLocation textureDecayed;
    private final ModelPart root;

    public DecayableTagPrefixItemModel(ModelPart root, ResourceLocation texture, ResourceLocation textureDecayed) {
        super(RenderType::entitySolid);
        this.texture = texture;
        this.textureDecayed = textureDecayed;
        this.root = root;
    }
